 ...
 * ********************************************************************
 * 
 * According to the class author Robert Harder:
 * 
 * Also Note: I've condensed all the functionality into one FileDrop.java
 * class to make it easier to copy the single file into your projects.
 * Since this is Public Domain, there's no need to include yet another jar
 * file in your project and reference a license - just add FileDrop.java to
 * your package and you're off!
 * 
 * One more thing: since this is Public Domain, feel free to change the Java
 * package name if it makes your life a little easier.
 * 
 ...
 * \endcond
 *
 * <b>FileDrop.java</b>: Makes it easy to drag and drop files from the
 * operating system to a Java program.
 */
